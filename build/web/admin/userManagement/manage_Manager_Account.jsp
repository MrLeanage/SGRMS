                    ...
                    <div class="container-fluid page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                        <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                            ...
                            <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                                <h2 class="mb-0">MANAGER ACCOUNTS</h2>

                                <ol class="breadcrumb p-0 m-0">
                                    <li class="breadcrumb-item">User Management - Manage Manger Accounts</li>
                ...
                <div class="container-fluid page__container">
                    <div class="page-section">
                        ...
                        <div class="container p-1">
                            <p>Add Your System - Employee heading Detail description here</p>
                        </div>
                                        ...
                                        <table class="table table-bordered table-striped mb-0 data-table sortable" id="usersTable">
                                            ...
                                            <tbody  id="myTable">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%=userInfo.getuSpecialization()%></td>
                        ...
                        <div class="row mb-32pt">
                            ...
                            <div class="col-lg-12 d-flex align-items-center">
                                <div class="flex"
                                     style="max-width: 100%">
                                    <form action="<%=request.getContextPath()%>/ManageManagerInfo" method="POST">
                                            ...
                                            <div class="form-row">
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           id="eID"
                                                           value="">
                                                    <div class="invalid-feedback">Please provide Employee/User ID</div>
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <select class="form-control" name="accType" id="accType">
                                                        <option>Manager - Level 2</option>
                                                        <option>Manager - Level 3</option>
                                                    </select>
                                                </div>
                                                <div class="col-12 col-md-6 mb-3">
                                                    <label class="form-label"
        ...
        <script>
            ...
            for (var i = 0; i < table.rows.length; i++) {
                table.rows[i].onclick = function ()
                {
                    ...
                    document.getElementById("specialization").value = this.cells[4].innerHTML;
                    document.getElementById("accStatus").value = this.cells[5].innerHTML;   
                    $("#passwordDiv").hide();
                    $("#add").hide();
                    $("#update").show();
